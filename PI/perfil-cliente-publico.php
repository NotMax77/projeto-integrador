...
<head>
    ...
    <title>Perfil de <?= e($nomeCliente) ?> | Babá Amiga</title>
...
<body>
    ...
    <main class="perfil-wrap">
        <section class="perfil-cabecalho"><img class="perfil-foto" src="<?= e($foto) ?>" alt="Foto de <?= e($nomeCliente) ?>">
            <div>
                <span class="badge"><i class="fa-solid fa-user"></i> Cliente</span>
                <h1><?= e($nomeCliente) ?></h1>
    ...
    </main><?php include __DIR__ . '/include/footer.php'; ?>
</body>
